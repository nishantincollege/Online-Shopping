...
<%
		...
		String t2=request.getParameter("text2");
                ...
                rst=stmt.executeQuery("select * from qualificationtab where edName= '" + t1 + "'");
                if (rst.next())
                {
...
<div id="admineducationt_id">
<table border="0"> 
<tr><td height ="100" width="25%"></td><td>

    <form method="POST" name="form5"    action="admineducation.jsp">
    <table border="0"> 
    <tr> <td height="20" colspan="2"> <img style="-webkit-user-select: none" src="images/ednames.bmp"> </td> </tr>    
    <tr> <td height="60" colspan="2"> </td> </tr> 
    <tr> <td height="40"> Qualification Name </td> <td> <input type="text" name="text1" value="" required=""></td> </tr>
